...
public final class GreeterGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "flotilla.Greeter";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<app.flotilla.HelloRequest,
      app.flotilla.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = app.flotilla.HelloRequest.class,
      responseType = app.flotilla.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<app.flotilla.HelloRequest,
      app.flotilla.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<app.flotilla.HelloRequest, app.flotilla.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<app.flotilla.HelloRequest, app.flotilla.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  app.flotilla.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  app.flotilla.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(app.flotilla.HelloRequest request,
        io.grpc.stub.StreamObserver<app.flotilla.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(app.flotilla.HelloRequest request,
        io.grpc.stub.StreamObserver<app.flotilla.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
    ...
    /**
     */
    public app.flotilla.HelloReply sayHello(app.flotilla.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<app.flotilla.HelloReply> sayHello(
        app.flotilla.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((app.flotilla.HelloRequest) request,
              (io.grpc.stub.StreamObserver<app.flotilla.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              app.flotilla.HelloRequest,
              app.flotilla.HelloReply>(
